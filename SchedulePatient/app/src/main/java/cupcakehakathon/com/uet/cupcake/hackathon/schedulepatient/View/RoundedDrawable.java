package cupcakehakathon.com.uet.cupcake.hackathon.schedulepatient.View;
...
public class RoundedDrawable extends Drawable {
    ...
    private final RectF mOuterCircleRect = new RectF();
    ...
    public void setRing(boolean hasRing, float ringRadius, int ringColor, float ringWidth) {
        this.hasRing = hasRing;
        this.ringColor = ringColor;
        this.ringRadius = ringRadius;
        this.ringWidth = ringWidth;
        mOuterCirclePaint.setColor(ringColor);
        mOuterCirclePaint.setStrokeWidth(ringWidth);
    }
    ...
    private void updateShaderMatrix() {
        ...
        mOuterCircleRect.set(mBorderRect);
        mBitmapShader.setLocalMatrix(mShaderMatrix);

        mDrawableRect.set(mOuterCircleRect.left + ringRadius, mOuterCircleRect.top + ringRadius,
                mOuterCircleRect.right - ringRadius, mOuterCircleRect.bottom - ringRadius);
        mOuterCircleRect.inset(ringWidth, ringWidth);
    }
    ...
    public void draw(Canvas canvas) {
        if (mOval) {
            ...
            canvas.drawOval(mOuterCircleRect, mOuterCirclePaint);
        } else {
            if (mBorderWidth > 0) {
