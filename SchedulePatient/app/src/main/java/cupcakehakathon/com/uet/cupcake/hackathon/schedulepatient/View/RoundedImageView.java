...
public class RoundedImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    public RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        hasRing = a.getBoolean(R.styleable.RoundedImageView_ring, false);
        ringColor = a.getColor(R.styleable.RoundedImageView_ring_color, Color.TRANSPARENT);
        ringRadius = a.getDimensionPixelSize(R.styleable.RoundedImageView_ring_distance, 0);
        ringWidth = a.getDimensionPixelSize(R.styleable.RoundedImageView_ring_width, 0);
    ...
    private void updateAttrs(Drawable drawable) {
        ...
        if (drawable instanceof RoundedDrawable) {
            ((RoundedDrawable) drawable)
                    ...
                    .setOval(isOval)
                    .setRing(hasRing, ringRadius, ringColor, ringWidth);
